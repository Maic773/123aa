...
if(!usePairingCode && !fs.existsSync(`${qrcode}/creds.json`)) console.log(colors.yellow("Se você não tiver outro aparelho para ler oq qrcode, você pode usar, ( sh start.sh sim ), sem os parenteses, e você conectará com código de emparelhamento, o novo modelo."));
...
// PEGAR DESCRIÇÃO DO GRUPO. /ANDRNLD
...
`〔 - _ ALEATORY MD 3.7 _ - CONECTADO COM SUCESSO.. 〕`))
rl.close();
